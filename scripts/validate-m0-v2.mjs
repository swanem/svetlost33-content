...
if (process.argv[1] === import.meta.filename) {
  ...
  const keyIndex = process.argv.indexOf('--key'); const idIndex = process.argv.indexOf('--key-id'); const platformIndex = process.argv.indexOf('--platform'); const versionIndex = process.argv.indexOf('--client-version'); const channelIndex = process.argv.indexOf('--channel');
